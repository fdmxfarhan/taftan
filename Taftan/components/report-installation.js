...
const ReportInstallation = ({ reportDetail, provinceName, setprovinceName, cityName, setcityName, zoneName, setzoneName, installationReportInfo, setinstallationReportInfo, setIsValid }) => {
    ...
    useEffect(() => {
        const validateFields = () => {
            const requiredFields = [
                installationReportInfo.deviceName,
                installationReportInfo.deviceSerial,
                installationReportInfo.deviceTerminal,
            ...
            const isValid = requiredFields.every(field => field != null && field !== '');
            setIsValid(isValid);
        };
