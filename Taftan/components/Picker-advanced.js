...
const AdvancedScrollPicker = ({ items, onValueChange, defaultValue, getLabel }) => {
  const [selectedIndex, setSelectedIndex] = useState(
    defaultValue ? items.findIndex((item) => getLabel(item) === defaultValue) : 0
  );
...
export default AdvancedScrollPicker;
