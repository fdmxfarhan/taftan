...
const MaxModulesExceededPopup = ({ popupEN, setPopupEN }) => {
    return (
        <View>
            <Popup modalVisible={popupEN} setModalVisible={setPopupEN}>
                <Text style={styles.centerlabel}>تعداد ماژول وارد شده بیشتر از حداکثر تعداد تعریف شده در پیکربندی است</Text>
...
export default MaxModulesExceededPopup; 