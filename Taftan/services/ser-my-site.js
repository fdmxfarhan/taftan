...
export const submitMySiteRequest = async (skip, take, navigation) => {
    ...
    try {
        ...
        const response = await api.post('/RequestSiteController/loadMySiteRequestList', {
            "skip": skip,
            "take": take,
            "sort": [
                {
        ...
        console.log('Error submitting /RequestSiteController/loadMySiteRequestList request:', error);
        ...
        return { success: false, error: 'Failed to submit my site request' };
    }
}; 