...
export const submitMyProjectRequest = async (skip, take, navigation) => {
    ...
    try {
        ...
        const response = await api.post('/RequestProjectController/loadMyProjectRequestList', {
            "skip": skip,
            "take": take,
            "sort": [
                {
        ...
        console.log('Error submitting /RequestProjectController/loadMyProjectRequestList request:', error);
        ...
        return { success: false, error: 'Failed to submit my project request' };
    }
}; 