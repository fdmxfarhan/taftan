...
export const LoadAllowedRequestAction = async (requestId, navigation) => {
    ...
    try {
        ...
        //     }
        // });
        const response = await CustomHeaderRequest.sendGetRequestWithCustomHeader(`http://taftantest.adonistech.ir:8000/Services/Taftan/api/RequestController/LoadAllowedRequestAction?requestId=${requestId}`,{
            Authorization: `Bearer ${authData.token}`,
